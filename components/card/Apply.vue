<template>
  <div
    ...
    <h5>Noteworthy technology
      acquisitions 2021</h5>

    <p>Here are the biggest enterprise technology acquisitions
...
<style lang="postcss">
.card {
  @apply max-w-md mx-auto p-6 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700;
